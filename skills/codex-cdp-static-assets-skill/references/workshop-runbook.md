...
4. Present the exact host candidates, automation mode, autosave/page-creation actions, Module-variable handling, the three-state matrix, optional element-level screenshots, and asset limits as a **single consolidated authorization**.
